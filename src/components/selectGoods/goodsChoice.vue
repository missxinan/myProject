<template>
  <div class="goods-choice">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="寄拍" name="second">
        <el-table
          :key="tableKey"
          v-loading="listLoading"
          :data="list"
        ...
        >
		  ...
		  <el-table-column label="寄拍编号" align="center" >
		    <template slot-scope="scope">
		      {{ scope.row.mallNumber }}
		    </template>
		  </el-table-column>
		  <el-table-column label="寄拍者/手机号"  align="center" >
		     <template slot-scope="scope">
		 ...
		 <el-table-column label="消耗积分"  align="center" >
		  ...
		  <el-table-column label="寄拍次数" align="center" >
		    <template slot-scope="scope">
		      {{ scope.row.times }}
		    </template>
		  </el-table-column>
	  ...
	  <el-tab-pane label="捡漏" name="third">
	    <el-table
	      :key="tableKey"
	      v-loading="listLoading"
	      :data="list"
	    ...
	    >
	      ...
	      <el-table-column label="分类"  align="center" >
	        <template slot-scope="scope">
	          <!-- <span>{{ scope.row.categoryName }}</span> -->
	          <span v-for="item in categoryArry"
					:key="item.value"><span v-if="item.value==scope.row.categoryId">{{item.label}}</span></span>
	        </template>
	      </el-table-column>
	      <el-table-column label="成本价"  align="center" >
	        <template slot-scope="scope">
