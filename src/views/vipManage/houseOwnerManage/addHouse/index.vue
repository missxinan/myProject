	...
	<div class="headQuarters-addOrEdit">
		...
		<div class="addOrEdit-content">
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
				...
				<el-form-item label="等级" prop="phone" required>
					<el-input class="item-input" :disabled="partnerId !=='' ? true : false" v-model="ruleForm.vipPhone" placeholder="请输入联系人手机号"></el-input>
				</el-form-item>
				<el-form-item label="归属" prop="cPhone">
				...
				<el-form-item label="排序" prop="detailedAddress">
					<el-input
						class="item-input"
						type="textarea"
						:rows="2"
...
export default {
	...
	methods:{
		...
		getPartnerDetail(){
			...
			partnerDetail(data).then(res =>{
				if(res.code == 0){
					let datas = res.data;
					this.ruleForm.nick = datas.nick;
