<template>
	<div class="table-box">
		...
		<tree-table :data="data" v-on:handleCreate="handleCreate" v-on:handleUpdate="handleUpdate" v-on:handleDelete="handleDelete"
		...
		<el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
			<el-form ref="dataForm" :model="temp" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
				...
				<el-form-item label="类目图" required>
					<el-upload ref="upload" action="" list-type="picture-card" :limit="1" :auto-upload="false"
		...
		<el-dialog :visible.sync="dialogPvVisible" title="Reading statistics">
			<el-table :data="pvData" border fit highlight-current-row style="width: 100%" max-height="650">
		...
		<el-dialog title="修改" :visible.sync="dialogs">
			<el-form ref="dataFormxiugai" :model="tempxiugai" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
				<el-form-item label="分类名称" prop="menuName" maxlength="6" show-word-limit required>
